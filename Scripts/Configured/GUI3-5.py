...
layout = [
    ...
    [sg.Text('SlowDoS'), sg.Checkbox('', key='slowdos_enabled'), sg.InputText(size=6, key='slowdos_keepalive'), sg.InputText(size=6, key='slowdos_duration')],
    [sg.Text('Malaria'), sg.Checkbox('', key='malaria_enabled'), sg.InputText(size=6, key='malaria_message_count'), sg.InputText(size=6, key='malaria_processes'), sg.InputText(size=6, key='malaria_message_size')],
    [sg.Text('Brute Force'), sg.Checkbox('', key='bruteforce_enabled'), sg.InputText(size=20, key='bruteforce_username'), sg.InputText(size=20, key='bruteforce_wordlist')],
